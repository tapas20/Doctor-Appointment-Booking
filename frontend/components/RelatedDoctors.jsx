              ...
              <div className="flex flex-col flex-grow p-6">
                ...
                <div className="mt-auto space-y-3">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <button
                      className="bg-gradient-to-r from-[#5f6FFF] to-[#8B9AFF] text-white px-5 py-2 rounded-lg text-sm font-medium hover:opacity-90 transition-opacity duration-300 shadow-md"
                      onClick={(e) => {
                        e.stopPropagation();
                        router.push(`/appointment/${doctor._id}`);
                      }}
